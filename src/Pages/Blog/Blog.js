        ...
        <div className='grid gap-6 grid-cols-1  lg:grid-cols-2 mt-6 '>
            <div>
                ...
                <p className='text-justify'>
                    ...
                    1.Local state: Local state is data we manage in one or another component.Local state is most often managed in React using the useState hook. <br />
                    2.Global state: Global state is data we manage across multiple components.Global state is necessary when we want to get and update data anywhere in our app, or in multiple components at least. <br />
            ...
            <div>
                ...
                <br />
                <p className='text-justify'>React <br />
